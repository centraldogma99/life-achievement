...
import { updateAchievementProgress, getNewlyUnlockedAchievements } from './utils/achievements';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Life Achievement</h1>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-green-600">{stats.unlockedAchievements}</div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          {/* 탭 콘텐츠 */}
          {activeTab === 'diary' && (
            <DiaryEntry onSave={handleDiarySave} />
          )}
      ...
      <footer className="bg-white/50 backdrop-blur-sm border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-sm text-gray-600">
            ...
            <p>
              Life Achievement - 당신의 성장을 기록하고 인정받으세요.
            </p>
          </div>
        </div>
      </footer>
