...
3.  **판단 근거 제시:** 달성된 것으로 판단한 모든 업적에 대해, 왜 그렇게 판단했는지에 대한 핵심적인 '이유'를 반드시 제시해야 합니다. '이유'는 일기 내용에서 직접적인 단서가 되는 문구나 구절을 포함해야 합니다.
      ...
      "achieved_list": [
        {
          "id": "reading_a_book",
          "name": "지혜의 한 페이지",
          "reason": "사용자가 '데일 카네기 인간관계론'을 20페이지 정도 읽었다고 명시함."
        },
        {
          "id": "gratitude_expression",
          "name": "감사하는 마음",
          "reason": "사용자가 '감사한 마음이 든다'고 직접적으로 표현함."
        }
      ]
    }
    \`\`\`
